...
@ModelConfig(pluralName = "Instruments")
@Index(name = "musician", fields = {"musicianId"})
@Index(name = "band", fields = {"bandId"})
public final class Instrument implements Model {
  public static final QueryField ID = field("Instrument", "id");
  public static final QueryField NAME = field("Instrument", "name");
  public static final QueryField MUSICIAN = field("Instrument", "musicianId");
  public static final QueryField BAND = field("Instrument", "bandId");
  ...
  private Instrument(String id, String name, Musician musician, Band band) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), instrument.getId()) &&
              ObjectsCompat.equals(getName(), instrument.getName()) &&
              ObjectsCompat.equals(getMusician(), instrument.getMusician()) &&
              ObjectsCompat.equals(getBand(), instrument.getBand());
      }
  }
   ...
   */
  public static Instrument justId(String id) {
    try {
